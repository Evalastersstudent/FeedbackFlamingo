function main() {
      ...
      var DEMOtarieven = document.getElementById("DEMOtarieven");
      var pijlDEMOtarieven = document.getElementById("pijlDEMOtarieven");
      DEMOtarieven.addEventListener("mouseover", function() {
        pijlDEMOtarieven.style.borderColor = "#e3314b";
      });
      DEMOtarieven.addEventListener("mouseout", function() {
        pijlDEMOtarieven.style.borderColor = "white";
      });
}
